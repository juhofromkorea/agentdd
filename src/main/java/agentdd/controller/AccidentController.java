                ...
                if ("/detail".equals(pathInfo)) {
                    ...
                    if (hasPolNo && hasClaimNo) {
                        request.setAttribute("fieldErrors",
                                java.util.Map.of("polNo", "新規受付の場合は証券番号のみ、更新の場合は事故受付番号のみを入力してください。"));
                        request.getRequestDispatcher("/WEB-INF/view/accident/accident.jsp").forward(request, response);
                        return;
                    }
                    ...
                    if (hasClaimNo) {
                        ...
                        if (accidentData == null) {
                            ...
                            request.getRequestDispatcher("/WEB-INF/view/accident/accident.jsp").forward(request,
                                    response);
                            return;
                        }
                    ...
                    // B: 証券番号が入力された場合 (新規受付)
                        ...
                        if (contractData == null) {
                            request.setAttribute("fieldErrors",
                                    java.util.Map.of("polNo", "該当する証券番号（契約情報）が見つかりませんでした。"));
                            request.getRequestDispatcher("/WEB-INF/view/accident/accident.jsp").forward(request,
                                    response);
                            return;
                        }
                    ...
                    String errorField = hasClaimNo ? "claimNo" : "polNo";
                    ...
                    if (contractData == null) {
                        ...
                        request.getRequestDispatcher(
                                "/WEB-INF/view/accident/accident.jsp").forward(request, response);
                        return;
                    }
                    ...
                    if (claimData == null
                            ...
                            || accidentData == null
                            || accidentData.getCoverId() != claimData.getCoverId()) {
                        request.setAttribute(
                                "fieldErrors",
                                java.util.Map.of(
                                        errorField,
