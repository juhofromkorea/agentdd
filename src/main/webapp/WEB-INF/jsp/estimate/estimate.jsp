                    ...
                    <div class="estimate-form-grid">
                        ...
                        <div class="estimate-radio-group">
                          <label>
                            <input
                              ...
                              value="1"
                              <c:if test="${empty contract or contract.insuredKbn == 0 or contract.insuredKbn == 1}">checked</c:if>
                              form="coverage-form"
                            />
                            個人
                          </label>
                          <label>
                            <input
                              ...
                              value="2"
                              <c:if test="${contract.insuredKbn == 2}">checked</c:if>
                              form="coverage-form"
                            />
                            法人
                          </label>
                      ...
                      >
                        ...
                        <div class="estimate-radio-group estimate-radio-group--control">
                          <label>
                            <input type="radio" name="gender" value="1" form="coverage-form" <c:if test="${empty contract or contract.gender == 0 or contract.gender == 1}">checked</c:if> />
                            男
                          </label>
                          <label>
                            <input type="radio" name="gender" value="2" form="coverage-form" <c:if test="${contract.gender == 2}">checked</c:if> />
                            女
                          </label>
                        </div>
                      </div>
                      <label class="estimate-field estimate-field--personal">
                        ...
                        <input
                          ...
                          name="birthday"
                          form="coverage-form"
                          <c:if test="${not empty contract.birthday and fn:length(contract.birthday) == 8}">value="${fn:substring(contract.birthday, 0, 4)}-${fn:substring(contract.birthday, 4, 6)}-${fn:substring(contract.birthday, 6, 8)}"</c:if>
                        />
                      </label>
                      ...
                      <label class="estimate-field">
                        ...
                        <input
                          ...
                          name="conclusionDate"
                          form="coverage-form"
                          <c:if test="${not empty contract.conclusionDate and fn:length(contract.conclusionDate) == 8}">value="${fn:substring(contract.conclusionDate, 0, 4)}-${fn:substring(contract.conclusionDate, 4, 6)}-${fn:substring(contract.conclusionDate, 6, 8)}"</c:if>
                        />
                      </label>
                      ...
                      <label class="estimate-field">
                        ...
                        <select class="estimate-control" name="paymentMethod" form="coverage-form">
                          <option value="1" <c:if test="${contract.paymentMethod == 0 or contract.paymentMethod == 1}">selected</c:if>>クレジットカード</option>
                          <option value="2" <c:if test="${contract.paymentMethod == 2}">selected</c:if>>口座振替</option>
                          <option value="3" <c:if test="${contract.paymentMethod == 3}">selected</c:if>>払込票</option>
                        </select>
                      </label>
                      <label class="estimate-field">
                        <span class="estimate-field__label">払込回数</span>
                        <select class="estimate-control" name="installment" form="coverage-form">
                          <option value="1" <c:if test="${contract.installment == 0 or contract.installment == 1}">selected</c:if>>1</option>
                          <option value="6" <c:if test="${contract.installment == 6}">selected</c:if>>6</option>
                          <option value="12" <c:if test="${contract.installment == 12}">selected</c:if>>12</option>
                        </select>
                      </label>
                    </div>
                  </fieldset>
                  ...
                  <fieldset class="estimate-section">
                    ...
                    <div class="estimate-premium-summary">
                      <div class="estimate-premium">
                        ...
                        <strong>
                          <c:choose>
                            <c:when test="${calculated}"><fmt:formatNumber value="${claim.premiumAmount}" type="number" />円</c:when>
                      ...
                      <div class="estimate-premium">
                        ...
                        <strong>
                          <c:choose>
                            <c:when test="${calculated}"><fmt:formatNumber value="${claim.premiumInstallment}" type="number" />円</c:when>
                            <c:otherwise>未計算</c:otherwise>
                          </c:choose>
                        </strong>
                      </div>
                      ...
                      <label class="estimate-field">
                        ...
                        <output class="estimate-control estimate-control--readonly">
                          <c:if test="${calculated}"><fmt:formatNumber value="${claim.vehiclePrice}" type="number" />円</c:if>
                        </output>
                      </label>

                      <label class="estimate-field">
                        <span class="estimate-field__label">車両料率</span>
                        <output class="estimate-control estimate-control--readonly"><fmt:formatNumber value="${claim.vehicleRates}" maxFractionDigits="2" /></output>
                      </label>
                      <label class="estimate-field">
                        <span class="estimate-field__label">対人料率</span>
                        <output class="estimate-control estimate-control--readonly"><fmt:formatNumber value="${claim.bodilyRates}" maxFractionDigits="2" /></output>
                      </label>
                      <label class="estimate-field">
                        <span class="estimate-field__label">対物料率</span>
                        <output class="estimate-control estimate-control--readonly"><fmt:formatNumber value="${claim.propertyDamageRates}" maxFractionDigits="2" /></output>
                      </label>
                      <label class="estimate-field">
                        <span class="estimate-field__label">傷害料率</span>
                        <output class="estimate-control estimate-control--readonly"><fmt:formatNumber value="${claim.accidentRates}" maxFractionDigits="2" /></output>
                      </label>
